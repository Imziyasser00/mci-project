					...
					<div class="portlet box grey-cascade">
						...
						<div class="portlet-body">
							...
							<tbody>
								...
								<?php			
								include_once 'bd.php';
								$selectEcmaj=$connexion->query("select * from em where annee = '".$an."' and etat=0");
								...
								<td>'.$commentaire.'</td>
								<td>
								<a class="" href="suppem2.php?idpoint='.$idpoint.'&an='.$an.'" onclick="return(confirm(\'Etes-vous sûr de vouloir supprimer ?\'))"; id="Acc" title="supprimer">      <span class="fa fa-trash-o"></span></a>
