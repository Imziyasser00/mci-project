							...
							<div class="tab-pane active" id="tab_2">
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-folder-o"></i>Recherche 
										</div>
										<div class="tools">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="listediffdoc.php" class="form-horizontal" method="post">
											<div class="form-body">
														...
														<div class="form-group has-error">
															...
															<div class="col-md-7">
																<select name="ser" class="select2me form-control">
																	...
																	include_once bd.php;
																	if($adp==1){
																	$req1=$connexion->query("select * from document order by id_service ");
																	}	elseif($adp==2){
																	$req1=$connexion->query("select * from document where ajtpar='2' order by id_service");
																	}	elseif($adp==3){
																	$req1=$connexion->query("select * from document where ajtpar='3' order by id_service");
																	}
												...
												<div class="row">
													<div class="col-md-offset-3 col-md-9">
														<center><button type="submit" name="valider" class="btn btn-circle blue">Valider</button></center>
...
if(isset($_POST['valider'])){
	if(isset($_POST['ser'])){
		...
		$serpost=$_POST['ser'];		
		header("Location: diffselecteddoc.php?ser=$serpost");
