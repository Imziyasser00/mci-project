...
if (version_compare(PHP_VERSION, '5.4.0', '>=')) {
  ...
  ob_start(null, 0, false);
	...
	$Sname=$objser['nom'];
	$cs=0;
	$reqa=$connexion->query("select id_sservice from utilisateur where id=$id");
	$objsera = $reqa->Fetch(PDO::FETCH_ASSOC);
	$idproc=$objsera['id_sservice'];
							...
							<div class="tab-pane active" id="tab_2">
								<div class="portlet box blue">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="completerPlan0.php" class="form-horizontal" method="post" >
											<div class="form-body">						
												...
												<div class="form-group has-error">
															...
															<div class="col-md-4">
																<select name="anne" class="select2me form-control">																	
