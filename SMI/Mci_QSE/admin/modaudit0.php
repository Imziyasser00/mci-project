			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						...
						<a href="javascript:;" id="Acc">Modifier Audit</a>
							...
							<div class="tab-pane active" id="tab_2">
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-folder-o"></i>Modifier un audit
										</div>
										<div class="tools">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="modaudit.php" class="form-horizontal" method="post" >
											<div class="form-body">						
											...
											<div class="form-group has-error">
															...
															<div class="col-md-4">
																<select name="sem" class="select2me form-control">
																	...
																	<?php
																	include_once bd.php;
																	$req1=$connexion->query("select * from semestre");
																	$nbr=$req1->rowcount();
																	if($nbr!=0){
												...
												<div class="form-group has-error">
															...
															<div class="col-md-4">
																<select name="ann" class="select2me form-control">
																	
																	<?php
																	include_once bd.php;
																	$req1=$connexion->query("select * from annee");
																	$nbr=$req1->rowcount();
																	if($nbr!=0){
																	while  ($obj = $req1->Fetch(PDO::FETCH_ASSOC)) 
																	{
