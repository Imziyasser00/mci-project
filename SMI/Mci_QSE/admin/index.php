...
<?php
	...
	$Sname=$objser['nom'];
	$openfrom=0;
	include_once 'fonction/remplirEm.php';
	include_once 'fonction/notificationFEM.php';
?>
<head>
<meta charset="utf-8"/>
			...
			<table>
				<tbody>
					<tr>
						...
						<td class="auto-style1" style="height: 72px"><b>C</b>onsulter la <a href="pqse.php">Politique QSE </a> ,le <a href="mmi.php">Manuel Management Intégré </a>,et le <a href="cde.php">Code d'éthique</a>
						.</td>
