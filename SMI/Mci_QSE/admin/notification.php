						...
						<div class="portlet-body">
							...
							<?php $j=0; while($j < $iVEX ){								
								...
								<tr>
									...
									<span class="label label-sm label-icon label-warning">
									<i class="fa fa-file-o"></i>
									</span>Création de fiche d'écart
									</td>
									<td>
								<?php echo '<a href="ficheEcart1.php?id='.$NOT_EM[$j]['id'].'&idN='.$NOT_EM[$j]['idN'].'" title="Créer la fiche d\'écart majeur d\'audit n°"'.$numAll.'"">';?>
								...
								<span class="label label-sm label-icon label-warning">
									...
									<td>
									<?php echo '<a href="ficheEcart1.php?id='.$NOT_EMa[$j]['id'].'" title="Créer la fiche d\'écart majeur d\'audit n°"'.$numAll.'"">';?>
								...
								<span class="label label-sm label-icon label-warning">
									...
									Validation de la fiche d'écart
									</td>
									<td>
									<?php echo '<a href="ficheEcart1.php?id='.$NOT_EMd[$j]['id'].'" title="Créer la fiche d\'écart majeur d\'audit n°"'.$numAll.'"">';?>
