							...
							<div class="tab-pane active" id="tab_2">
								<div class="portlet box blue">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-folder-o"></i>Ecart majeur
										</div>
										<div class="tools">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="listecart.php" class="form-horizontal" method="post" >
											<div class="form-body">						
												...
												<div class="form-group has-error">
															...
															<div class="col-md-4">
																<select name="idproc" class="select2me form-control">
																	...
																	include_once 'bd.php';
																	if($adp==1){
																	$req1=$connexion->query("select * from sservice");
																	}
																	if($adp==2){
																		$req1=$connexion->query("select * from sservice");
																	}
												...
												<div class="row">
													<div class="col-md-offset-3 col-md-9">
														...
														<button type="submit" name="validerAll" class="btn btn-circle green">Voir liste globale</button>
													</div>
												</div>
													<div class="col-md-6">
													</div>
