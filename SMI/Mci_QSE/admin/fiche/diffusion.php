...
if (version_compare(PHP_VERSION, '5.4.0', '>=')) {
  ...
  //mail responsable
			...
			$txt = 'la fiche d\'audit n° '.$num.' du Processus '.$sservicenom.' est créée par le responsable d\'audit<br> <a href="http://192.168.2.106:8080/SMI/Mci_QSE/admin/pdf/reg/gerfiche.php?num='.$num.'">téléchargez la!</a>.
