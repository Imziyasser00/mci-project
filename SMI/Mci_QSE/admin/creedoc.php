...
if (version_compare(PHP_VERSION, '5.4.0', '>=')) {
  ...
  ob_start(null, 0, false);
	...
	$openfrom=0;
	$docget=$connexion->query("select * from service where service.id=$service");
	$objser = $servname->Fetch(PDO::FETCH_ASSOC);
	$Sname=$objser['nom'];
?>
<head>
							...
							<div class="tab-pane active" id="tab_2">
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="creedoc2.php?doc_id=<?php echo $doc_id; ?>" class="form-horizontal" method="post" enctype="multipart/form-data">
											<div class="form-body">
