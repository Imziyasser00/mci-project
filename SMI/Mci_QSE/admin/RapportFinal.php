						...
						<?php if($testeur2==1){?>
							<li>
								...
								<ul>
									...
									<li>
										<a href="#portlet-config01" data-toggle="modal" class="config" id="Acc">Référentiel Chapitre</a>
									</li>
							
									<li>
										<a href="#portlet-config02" data-toggle="modal" class="config" id="Acc">CHAMP DE L’AUDIT</a>
									</li>
									<li>
										<a href="#portlet-config03" data-toggle="modal" class="config" id="Acc">Points forts</a>
									</li>
									<li>
										<a href="#portlet-config04" data-toggle="modal" class="config" id="Acc">Points à améliorer</a>
									</li>									
									<li>
										<a href="#portlet-config05" data-toggle="modal" class="config" id="Acc">Ecarts mineurs</a>
									</li>
									<li>
										<a href="#portlet-config06" data-toggle="modal" class="config" id="Acc">Ecarts majeurs</a>
									</li>								
								</ul>
							</li>
							<li>
							<a  data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="false">Diffusions
								</a>
								<ul>
								<li>
		...
		<div id="foo2" style="display:block">
			...
			<table border="1" cellpadding="0" cellspacing="0" class="MsoNormalTable" width="696">
				...
				<tr>
					...
					<td colspan="2" width="401">
					<p class="MsoNormal" style="page-break-after: avoid;">
					<span>FOR-QSE 010 d<o:p></o:p></span></p>
					</td>
				</tr>
				<tr>
					<td width="143">
					...
					<td width="152">
					<p align="center" class="MsoNormal"><span><?php if($year>2017){echo "26/02/2018";} else {echo "26/02/2016"; }?> <o:p></o:p></span></p>
					</td>
				</tr>
			</table>
			...
			<table border="1" cellpadding="0" cellspacing="0" class="MsoNormalTable" width="639">
				<tr>
					...
					<p class="MsoNormal"><span lang="FR-CH">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $idr; ?></span></p>
					...
					</span><b>DATE DE L’AUDIT</b>&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;<?php echo $date ;?><o:p></o:p></span></p>
					<p class="MsoNormal"><span lang="FR-CH">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $lieu;?></span></p>
					...
					</p><p class="MsoNormal"><span lang="FR-CH">&nbsp;&nbsp;<?php echo $list6; ?></span></p>					
					</td>
				</tr>
				<tr>
					<td colspan="5" valign="top" width="639">
				...
				<tr>
					...
					<td colspan="2" width="213">
					<p align="center" class="MsoNormal"><span lang="FR-CH"><?php echo utf8_encode($fct); ?></span></p>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="4" width="429">
					<p align="center" class="MsoNormal"><span lang="EN-US"><?php echo $RA['complet'];?></span></p>
		...
		<center>
			...
			<table border="1" cellpadding="0" cellspacing="0" class="MsoNormalTable" width="639">
				...
				<tr>
					...
					<?php echo $showPA; ?>
					<p class="MsoNormal"><b><u><span lang="FR-CH">Ecarts&nbsp;majeurs:<o:p></o:p></span></u></b></p>
					<?php echo $showEma; ?>
					<p class="MsoNormal"><b><u><span lang="FR-CH">Ecarts&nbsp;mineurs:<o:p></o:p></span></u></b></p>
					<?php echo $showEm; ?>
			...
			<div class="modal fade" id="portlet-config01" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
						...
						<div class="portlet-body form">
						<form action="rapport/modificationRef.php?num=<?php echo $num; ?>" method="post" class="form-horizontal form-bordered">
								<div class="form-body">
								<?php 
								...
								<div class="form-group has-error">
													...
													<div class="col-md-11">
														<textarea id="maxlength_textarea" class="form-control" maxlength="225" rows="2" name="reps1"><?php echo utf8_encode($pointref);?></textarea>
															<span class="help-block">
															</span>
														</div>
									</div>						
			...
			<div class="modal fade" id="send" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="portlet-body form">
						<form action="rapport/send.php?num=<?php echo $num; ?>" method="post" class="form-horizontal form-bordered">
								<div class="form-body">
								<?php 
			...
			<!-- /.modal -->
			<!-- Référentiels chapitre model-->
			<div class="modal fade" id="portlet-config02" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
						...
						<div class="portlet-body form">
						<form action="rapport/modificationChamp.php?num=<?php echo $num; ?>" method="post" class="form-horizontal form-bordered">
								<div class="form-body">
								<?php 
								...
								<div class="form-group has-error">
													...
													<div class="col-md-11">
														<textarea id="maxlength_textarea" class="form-control" maxlength="225" rows="2"  name="champ"><?php echo $showchamp ;?></textarea>
															<span class="help-block">
															</span>
														</div>
									</div>						
			...
			<!-- /.modal -->
				<!-- Point fort model-->
			<div class="modal fade" id="portlet-config03" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
						...
						<div class="portlet-body form">
							...
							<form action="rapport/modificationPf.php?num=<?php echo $num; ?>" method="post" class="form-horizontal form-bordered">
								<div class="form-body">
								<?php 
								$i=0;
								$selectPF=$connexion->query('select * from point where type ="fort" and numero_audit="'.$num.'"');
								...
								<div class="form-group has-error" id="<?php echo $i.'v'; ?>" style="display:block">
													<label class="control-label col-md-13">Point fort  </label><a href="#" onclick="toggle_visibility('<?php echo $i.'v'; ?>','<?php echo $i.'d'; ?>'),cleartext('text<?php echo $i; ?>');" >
																<i class="fa fa-trash-o" id="<?php echo $i; ?>" style="visibility:visible"></i>
																
																</a>
													<div class="col-md-11">
														<textarea id="text<?php echo $i; ?>" class="form-control" maxlength="225" rows="2"  name="pointF[]"><?php echo utf8_encode($pointF) ;?></textarea>
															<span class="help-block">
															</span>
														</div>
								</div>						
								...
								<div class="form-group has-error" id="<?php echo $i.'v'; ?>" style="display:block">
													<label class="control-label col-md-13">Point fort  </label><a href="#" onclick="toggle_visibility('<?php echo $i.'v'; ?>','<?php echo $i.'d'; ?>'),cleartext('text<?php echo $i; ?>');" >
																...
																<a href="#" onclick="toggle_visibility('<?php echo $j.'v'; ?>','<?php echo $j.'d'; ?>'),toggle_visibility2('<?php echo 'ic1'.$i.'v'; ?>','<?php echo 'ic2'.$i.'v'; ?>'),cleartext('text<?php echo $j; ?>');" >
								...
								<div class="form-group has-error" id="<?php echo $j.'v'; ?>" style="display:none">
													<label class="control-label col-md-13">Nouveau point fort  </label><a href="#" onclick="toggle_visibility('<?php echo $j.'v'; ?>','<?php echo $j.'d'; ?>'),cleartext('text<?php echo $j; ?>')" >
																<i class="fa fa-trash-o" id="<?php echo $i; ?>" style="visibility:visible"></i>
																</a>
																<a href="#" onclick="toggle_visibility2('<?php echo 'ic1'.$i.'v'; ?>','<?php echo 'ic2'.$j.'v'; ?>'),cleartext('text<?php echo $j+1; ?>');" >
																</a>
													<div class="col-md-11">
														<textarea id="text<?php echo $j; ?>" class="form-control" maxlength="225" rows="2"  name="pointF[]"></textarea>
															<span class="help-block">
															</span>
														</div>
								</div>
								...
								?>
								<div class="form-group has-error" id="<?php echo $i.'v'; ?>" style="display:block">
													<label class="control-label col-md-13">Point fort test </label><a href="#" onclick="toggle_visibility('<?php echo $i.'v'; ?>','<?php echo $i.'d'; ?>'),cleartext('text<?php echo $i; ?>');" >
																<i class="fa fa-trash-o" id="<?php echo $i; ?>" style="visibility:visible"></i>
																</a>
																<a href="#" onclick="toggle_visibility('<?php echo $j.'v'; ?>','<?php echo $j.'d'; ?>'),toggle_visibility2('<?php echo 'ic1'.$i.'v'; ?>','<?php echo 'ic2'.$i.'v'; ?>'),cleartext('text<?php echo $j; ?>');" >
																<i class="fa fa-plus" id="ic1<?php echo $i.'v'; ?>" style="visibility:visible"></i>
													...
													<div class="col-md-11">
														<textarea id="text<?php echo $i; ?>" class="form-control" maxlength="225" rows="2"  name="pointF[]"></textarea>
															<span class="help-block">
															</span>
														</div>
								</div>						
			...
			<div class="modal fade" id="portlet-config04" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
						...
						<div class="portlet-body form">
						<form action="rapport/modificationPa.php?num=<?php echo $num; ?>" method="post" class="form-horizontal form-bordered">
								<div class="form-body">
								<?php 
								$i=0;
								$selectPA=$connexion->query('select * from point where type ="ameliorati" and numero_audit="'.$num.'"');
		...
		while($PA = $selectPA->Fetch(PDO::FETCH_ASSOC)){
			$pointA=$PA['commentaire'];	
								...
								<div class="form-group has-error" id="<?php echo $i.'vz'; ?>" style="display:block">
													<label class="control-label col-md-13">Point à améliorer </label><a href="#" onclick="toggle_visibility('<?php echo $i.'vz'; ?>','<?php echo $i.'dz'; ?>'),cleartext('texta<?php echo $i; ?>');" >
																<i class="fa fa-trash-o" id="<?php echo $i; ?>" style="visibility:visible"></i>
																
																</a>
													<div class="col-md-11">
														<textarea id="texta<?php echo $i; ?>" class="form-control" maxlength="225" rows="2"  name="pointA[]"><?php echo  utf8_encode($pointA) ;?></textarea>
															<span class="help-block">
															</span>
														</div>
								</div>						
								...
								<div class="form-group has-error" id="<?php echo $i.'vz'; ?>" style="display:block">
													<label class="control-label col-md-13">Point à améliorer </label><a href="#" onclick="toggle_visibility('<?php echo $i.'vz'; ?>','<?php echo $i.'dz'; ?>'),cleartext('texta<?php echo $i; ?>');" >
																...
																<a href="#" onclick="toggle_visibility('<?php echo $j.'vz'; ?>','<?php echo $j.'dz'; ?>'),toggle_visibility2('<?php echo 'ic1'.$i.'vz'; ?>','<?php echo 'ic2'.$i.'vz'; ?>'),cleartext('texta<?php echo $j; ?>');" >
								...
								<div class="form-group has-error" id="<?php echo $j.'vz'; ?>" style="display:none">
													<label class="control-label col-md-13">Nouveau point à améliorer </label><a href="#" onclick="toggle_visibility('<?php echo $j.'vz'; ?>','<?php echo $j.'dz'; ?>'),cleartext('texta<?php echo $j; ?>')" >
																<i class="fa fa-trash-o" id="<?php echo $i; ?>" style="visibility:visible"></i>
																</a>
																<a href="#" onclick="toggle_visibility2('<?php echo 'ic1'.$i.'vz'; ?>','<?php echo 'ic2'.$j.'vz'; ?>'),cleartext('texta<?php echo $j+1; ?>');" >
																
																</a>
													<div class="col-md-11">
														<textarea id="texta<?php echo $j; ?>" class="form-control" maxlength="225" rows="2"  name="pointA[]"></textarea>
															<span class="help-block">
															</span>
														</div>
								</div>
								...
								<?php
									...
									?>
								<div class="form-group has-error" id="<?php echo $i.'vz'; ?>" style="display:block">
													<label class="control-label col-md-13">Point à améliorer test</label><a href="#" onclick="toggle_visibility('<?php echo $i.'vz'; ?>','<?php echo $i.'dz'; ?>'),cleartext('texta<?php echo $i; ?>');" >
																<i class="fa fa-trash-o" id="<?php echo $i; ?>" style="visibility:visible"></i>
																</a>
																<a href="#" onclick="toggle_visibility('<?php echo $j.'vz'; ?>','<?php echo $j.'dz'; ?>'),toggle_visibility2('<?php echo 'ic1'.$i.'vz'; ?>','<?php echo 'ic2'.$i.'vz'; ?>'),cleartext('texta<?php echo $j; ?>');" >
																<i class="fa fa-plus" id="ic1<?php echo $i.'vz'; ?>" style="visibility:visible"></i>
													...
													<div class="col-md-11">
														<textarea id="texta<?php echo $i; ?>" class="form-control" maxlength="225" rows="2"  name="pointA[]"></textarea>
															<span class="help-block">
															</span>
														</div>
								</div>						
			...
			<!-- /.modal -->
				<!-- Point fort model-->
			<div class="modal fade" id="portlet-config05" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
						...
						<div class="portlet-body form">
							...
							<form action="rapport/modificationE.php?num=<?php echo $num; ?>" method="post" class="form-horizontal form-bordered">
								<div class="form-body">
								<?php 
								$i=0;
								$selectEm=$connexion->query('select * from point where type ="ecart mine" and numero_audit="'.$num.'"');
								...
								<div class="form-group has-error" id="<?php echo $i.'ve'; ?>" style="display:block">
													<label class="control-label col-md-13">Ecart mineur </label><a href="#" onclick="toggle_visibility('<?php echo $i.'ve'; ?>','<?php echo $i.'de'; ?>'),cleartext('texte<?php echo $i; ?>');" >
																<i class="fa fa-trash-o" id="<?php echo $i; ?>" style="visibility:visible"></i>
																
																</a>
													<div class="col-md-11">
														<textarea id="texte<?php echo $i; ?>" class="form-control" maxlength="225" rows="2"  name="pointEm[]"><?php echo utf8_encode($pointEm) ;?></textarea>
															<span class="help-block">
															</span>
														</div>
								</div>						
								...
								<div class="form-group has-error" id="<?php echo $i.'ve'; ?>" style="display:block">
													<label class="control-label col-md-13">Ecart mineur  </label><a href="#" onclick="toggle_visibility('<?php echo $i.'ve'; ?>','<?php echo $i.'de'; ?>'),cleartext('texte<?php echo $i; ?>');" >
																...
																<a href="#" onclick="toggle_visibility('<?php echo $j.'ve'; ?>','<?php echo $j.'de'; ?>'),toggle_visibility2('<?php echo 'ic1'.$i.'ve'; ?>','<?php echo 'ic2'.$i.'ve'; ?>'),cleartext('texte<?php echo $j; ?>');" >
								...
								<div class="form-group has-error" id="<?php echo $j.'ve'; ?>" style="display:none">
													<label class="control-label col-md-13">Nouveau Ecart mineur  </label><a href="#" onclick="toggle_visibility('<?php echo $j.'ve'; ?>','<?php echo $j.'de'; ?>'),cleartext('texte<?php echo $j; ?>')" >
																<i class="fa fa-trash-o" id="<?php echo $i; ?>" style="visibility:visible"></i>
																</a>
																<a href="#" onclick="toggle_visibility2('<?php echo 'ic1'.$i.'ve'; ?>','<?php echo 'ic2'.$j.'ve'; ?>'),cleartext('texte<?php echo $j+1; ?>');" >
																</a>
													<div class="col-md-11">
														<textarea id="texte<?php echo $j; ?>" class="form-control" maxlength="225" rows="2"  name="pointEm[]"></textarea>
															<span class="help-block">
															</span>
														</div>
								</div>
								...
								<div class="form-group has-error" id="<?php echo $i.'ve'; ?>" style="display:block">
													...
													<div class="col-md-11">
														<textarea id="texte<?php echo $i; ?>" class="form-control" maxlength="225" rows="2"  name="pointEm[]"></textarea>
															<span class="help-block">
															</span>
														</div>
								</div>						
			...
			<!-- /.modal -->
					<!-- Point fort model-->
			<div class="modal fade" id="portlet-config06" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
						...
						<div class="portlet-body form">
							...
							<form action="rapport/modificationEma.php?num=<?php echo $num; ?>" method="post" class="form-horizontal form-bordered">
								<div class="form-body">
								<?php 
								$i=0;
								$selectEma=$connexion->query('select * from point where type ="ecart maje" and numero_audit="'.$num.'"');
			...
			$pointEma=$Ema['commentaire'];																
								...
								<div class="form-group has-error" id="<?php echo $i.'vem'; ?>" style="display:block">
													<label class="control-label col-md-13">Ecart majeur </label><a href="#" onclick="toggle_visibility('<?php echo $i.'vem'; ?>','<?php echo $i.'dem'; ?>'),cleartext('textm<?php echo $i; ?>');" >
																<i class="fa fa-trash-o" id="<?php echo $i; ?>" style="visibility:visible"></i>
																
																</a>
													<div class="col-md-11">
														<textarea id="textm<?php echo $i; ?>" class="form-control" maxlength="225" rows="2"  name="pointEma[]"><?php echo utf8_encode($pointEma) ;?></textarea>
															<span class="help-block">
															</span>
														</div>
								</div>						
								...
								<div class="form-group has-error" id="<?php echo $i.'vem'; ?>" style="display:block">
													<label class="control-label col-md-13">Ecart majeur  </label><a href="#" onclick="toggle_visibility('<?php echo $i.'vem'; ?>','<?php echo $i.'dem'; ?>'),cleartext('textm<?php echo $i; ?>');" >
																...
																<a href="#" onclick="toggle_visibility('<?php echo $j.'vem'; ?>','<?php echo $j.'dem'; ?>'),toggle_visibility2('<?php echo 'ic1'.$i.'vem'; ?>','<?php echo 'ic2'.$i.'vem'; ?>'),cleartext('textm<?php echo $j; ?>');" >
																<i class="fa fa-plus" id="ic1<?php echo $i.'vem'; ?>" style="visibility:visible"></i>
																<i class="fa fa-minus" id="ic2<?php echo $i.'vem'; ?>" style="visibility:hidden"></i>
																</a>
													<div class="col-md-11">
														<textarea id="textm<?php echo $i; ?>" class="form-control" maxlength="225" rows="2"  name="pointEma[]"><?php echo utf8_encode($pointEma) ;?></textarea>
															<span class="help-block">
								...
								<div class="form-group has-error" id="<?php echo $j.'vem'; ?>" style="display:none">
													<label class="control-label col-md-13">Nouveau Ecart majeur  </label><a href="#" onclick="toggle_visibility('<?php echo $j.'vem'; ?>','<?php echo $j.'dem'; ?>'),cleartext('textm<?php echo $j; ?>')" >
																<i class="fa fa-trash-o" id="<?php echo $i; ?>" style="visibility:visible"></i>
																</a>
																<a href="#" onclick="toggle_visibility2('<?php echo 'ic1'.$i.'vem'; ?>','<?php echo 'ic2'.$j.'vem'; ?>'),cleartext('textm<?php echo $j+1; ?>');" >
																</a>
													<div class="col-md-11">
														<textarea id="textm<?php echo $j; ?>" class="form-control" maxlength="225" rows="2"  name="pointEma[]"></textarea>
															<span class="help-block">
															</span>
														</div>
								</div>
								...
								<div class="form-group has-error" id="<?php echo $i.'vem'; ?>" style="display:block">
													...
													<div class="col-md-11">
														<textarea id="textm<?php echo $i; ?>" class="form-control" maxlength="225" rows="2"  name="pointEma[]"></textarea>
															<span class="help-block">
															</span>
														</div>
								</div>						
