							...
							<div class="tab-pane active" id="tab_2">
								<div class="portlet box blue">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-folder-o"></i>Plan d'action
										</div>
										<div class="tools">
									...
									<div class="portlet-body form">
										...
										<form action="<?php echo 'completerPlan.php?&an='.$plan_ann.''; ?>" class="form-horizontal" method="post" >
											<div class="form-body">						
												
																					
												
												<div class="form-group has-error">
															<label class="col-md-3 control-label">Proccessus</label>
															<div class="col-md-4">
																<select name="idproc" class="select2me form-control">
																	
																	<?php
																	include_once 'bd.php';
																	if($idUser=='82'){
																	$req1=$connexion->query("select * from sservice where id='31' Union select * from sservice where id='33' Union select * from sservice where id='44'");
																	}
																	if($idUser=='47'){
																		$req1=$connexion->query("select * from sservice where id='5' Union select * from sservice where id='6'  Union select * from sservice where id='7'  Union select * from sservice where id='8'");
																	}
																	if($idUser=='69'){
																		$req1=$connexion->query("select * from sservice where id='1' Union select * from sservice where id='2'  Union select * from sservice where id='10'");
																	}
																	if($idUser=='63'){
																		$req1=$connexion->query("select * from sservice where id='5' Union select * from sservice where id='6'  Union select * from sservice where id='7'  Union select * from sservice where id='8'
																		
																		Union select * from sservice where id='1' Union select * from sservice where id='2' Union select * from sservice where id='10' Union select * from sservice where id='9'
																		");
																	}
																	$nbr=$req1->rowcount();
																	if($nbr!=0){
																	...
																	echo '<option value="'.$idproc.'">'.$nom.'</option>';
