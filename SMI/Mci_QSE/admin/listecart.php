...
<html lang="fr"> 
<?php
if(isset($_POST['validerAll'])){
	header("Location: ecartall0.php");
}
    session_start();
							...
							<div class="tab-pane active" id="tab_2">
								<div class="portlet box blue">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-folder-o"></i>Ecart majeur <?php echo $idproc; ?>
										</div>
										<div class="tools">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="listecart1.php" class="form-horizontal" method="post" >
											<div class="form-body">						
												...
												<div class="row">
													<div class="col-md-offset-3 col-md-9">
														<input type="hidden" value="<?php echo $idproc;?>" name="idproc">
