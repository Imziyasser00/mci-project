...
<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<i class="fa fa-file-o"></i>
						<a href="javascript:;" id="Acc">Plan d'orientation stratégique</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<i class="fa fa-eye"></i>
						<a href="../Documents/Plan d'orientation strategique/Plan d'orientation strategique.pdf" target="_blank" id="Acc">Visualiser</a>
		...
		<!-- BEGIN PAGE CONTENT-->
			...
			<div class="acc-page" style="height: 484px">
				...
				<div id="fich1" > 
				<object data="../Documents/Plan d'orientation strategique/Plan d'orientation strategique.pdf" type="text/html" codetype="application/pdf" style="width: 581px; height: 392px" ></object> 
				</div> 
