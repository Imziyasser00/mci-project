									...
									$SelectRaNom=$connexion->query("select nom , prenom ,fonction from utilisateur where utilisateur.id=$r");
										...
										$aRAselect = $SelectRaNom->Fetch(PDO::FETCH_ASSOC);
											$Raa['nom']=$aRAselect['nom'];
												...
												$fct=utf8_encode($aRAselect['fonction']);
  ...
  <tr>
	...
	<table border="2">
		...
		<tr>        
			...
			<td  width="300" align="center" clspane="2"><b>FOR-QSE 010 d</b></td>              
		</tr>	
		<tr>
			<td align="center"><b>Page/pages</b></td>       
			<td align="center" width="150">'.$this->getAliasNumPage().'/'.$this->getAliasNbPages().'</td>       
...
ob_end_clean();
$nm=str_replace('/', ' ', $num); 	
$num1='Rapport '.$ssnom.' audit '.$nm.'.pdf';
$pdf->Output($num1, "D");
