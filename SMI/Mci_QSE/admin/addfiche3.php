...
if (isset($_POST['from'])){
	...
	$addRA=$connexion->exec("INSERT INTO `auditeurprevu`(`id`, `id_auditeur`, `numero_audit`, `ann`, `fonction`) VALUES (null,'".$RA."','".$num."',".$ann.",'RA')");
	$addA=$connexion->exec("INSERT INTO `auditeurprevu`(`id`, `id_auditeur`, `numero_audit`, `ann`, `fonction`) VALUES (null,'".$A."','".$num.",'".$ann.",'A')");
	$addO=$connexion->exec("INSERT INTO `auditeurprevu`(`id`, `id_auditeur`, `numero_audit`, `ann`, `fonction`) VALUES (null,'".$O."','".$num."',".$ann.",'O')");
	...
	if($addauditp!=0){
		header("location:planaudit.php?&ann=$ann"); 
	}
	else{
		echo $idt;
