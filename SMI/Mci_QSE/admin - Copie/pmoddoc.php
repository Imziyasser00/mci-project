		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<!-- BEGIN EXAMPLE TABLE PORTLET-->
					 <form action="pmoddoc2.php?doc_id=<?php echo $doc_id; ?>" class="form-horizontal" method="post" >
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							...
							<?php include 'bd.php';															
								//point
							$req1=$connexion->query("select * from document where id='".$doc_id."'");
							while  ($obj_doc = $req1->Fetch(PDO::FETCH_ASSOC)) 
								{
						
								$etat = $obj_doc['Etat'];
								$rev_exp=$obj_doc['DATTREV'];
								...
								$des= preg_replace($patterns, $replacements, $string);
								...
								$statut='';
								$remarque='';
							$req212=$connexion->query("select * from planning2 where id_doc='".$doc_id."'");	
							...
							<tr>							
								<td valign="middle">
									 <center><br>'.utf8_encode($des).'</center>
								</td>																
								</td>	
								<td valign="middle">
								<br>
								...
								<td valign="middle">
									 <center><br><input class="form-control" id="mask_date" type="text" name="etat" disabled="disabled" value="'.utf8_encode($etat).'"/></center>
								</td>
								<td valign="middle"><br>
