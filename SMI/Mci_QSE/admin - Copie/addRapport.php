...
if($nbra==0 and valide($id_ra,$num)!=0){
	...
	$delref=$connexion->prepare("DELETE FROM POINT where type='ref' and numero_audit=?");
	$delref->execute(array($num));	
	$delchamp=$connexion->prepare("DELETE FROM POINT where type='champ' and numero_audit=?");
							...
							<div class="tab-pane active" id="tab_2">
								<div class="portlet box blue">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										 <form action="addRapport1.php?num=<?php echo $num ; ?>" class="form-horizontal" method="post" >
											<div class="form-body">			
													...
													<label class="control-label col-md-3"><b>Référentiel Chapitre :</b></label>
													...
													<div class="form-group has-error">
													<label class="control-label col-md-3"><b>CHAMP DE L’AUDIT:</b></label>
																
													<div class="col-md-6">
														<textarea id="text0" class="form-control" maxlength="225" rows="2" placeholder="Un maximum de 225 caractères" name="pf1"></textarea>
															<span class="help-block">
