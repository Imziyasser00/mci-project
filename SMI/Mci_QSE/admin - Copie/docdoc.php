					...
					<div class="portlet box grey-cascade">
						...
						<div class="portlet-body">
							...
							<tbody>
								...
								echo '<td>'.$nom.'';if( $ajt==1 || $ajt==$adp){ echo' <a href="moddoc.php?doc_id='.$id_doc.'" onclick="return(confirm(\'Etes-vous sûr de vouloir Modifier ce document?\'))"; id="Acc" title="Modifier">      <span class="fa fa-pencil"></span></a>';}echo'</td>';
