...
if (version_compare(PHP_VERSION, '5.4.0', '>=')) {
  ...
  ob_start(null, 0, false);
	...
	$service = $_SESSION['ids'];
		$id = $_SESSION['id'];
	include_once 'bd.php';
	$audO=$connexion->prepare('select id from auditeur where id_utilisateur=? ');
	$audO->execute(array($id));
	$cnt=$audO->rowcount();
	$idauditeur1='';
	if($cnt!=0){
	$objtO = $audO->Fetch(PDO::FETCH_ASSOC);
	$idauditeur1=$objtO['id'];
	}
							...
							<div class="tab-pane active" id="tab_2">
								<div class="portlet box blue">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-folder-o"></i>Listes des rapports d'audit
										</div>
										<div class="tools">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="RapportFinal.php" class="form-horizontal" method="get" >
											<div class="form-body">						
												...
												<div class="form-group has-error">
															...
															<div class="col-md-4">
																<select name="num" class="select2me form-control">
																	...
																	$req1=$connexion->query("select audit_num from rapportcreeoupas where cop=1 ");
																	...
																	{
																	$n=$obj['audit_num'];
																	$req2=$connexion->query("select num_audit as audit_num from auditeefinal where id_utilisateur=$id and num_audit='".$n."'");
																	if($idauditeur1!=""){
																	$req3=$connexion->query("select numero_audit as audit_num from auditeurprevu where id_auditeur=$idauditeur1 and numero_audit='".$n."'");
																	}
																	$nbr2=$req2->rowcount();
																	if($nbr2!=0){
