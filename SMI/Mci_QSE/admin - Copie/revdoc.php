							...
							<div class="tab-pane active" id="tab_2">
								<div class="portlet box blue">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-folder-o"></i>Révision des documents
										</div>
										<div class="tools">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="revdoc1.php" class="form-horizontal" method="post" enctype="multipart/form-data">
											<div class="form-body">
										...
										<?php
													...
													$re=$connexion->query("SELECT * from document");
													echo'<select name="iddoc" class="select2me form-control">';	
													...
													while($ose2 = $re->Fetch(PDO::FETCH_ASSOC)){
														...
														echo'<option value="'.$iddoc.'">'.utf8_encode($nom).'																	
														</option>';
												...
												?>
															...
															<label class="control-label col-md-3">Date prévisionnelle</label>
										<div class="col-md-5"><?php $today = date("Y-n-j");   ?>
											<input class="form-control form-control-inline input-medium date-picker" size="15"  name="datepre" type="text" value="<?php echo $today ;?>"/>
																					</div>
