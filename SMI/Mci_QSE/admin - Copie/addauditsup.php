...
if (version_compare(PHP_VERSION, '5.4.0', '>=')) {
  ...
  ob_start(null, 0, false);
    ...
    elseif (!isset($_SESSION['nom']) || !isset($_GET['num']) || !isset($_GET['ann']) || !isset($_GET['sup'])) {
							...
							<div class="tab-pane active" id="tab_2">
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-folder-o"></i>Auditeurs supplémentaires
										</div>
										<div class="tools">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="addauditsup.php?num=<?php echo $num;?>&ann=<?php echo $ann;?>&sup=<?php echo $sup;?>" class="form-horizontal" method="post" >
											<div class="form-body">						
										...
										while($inc<$sup){											
											...
											<div class="form-group has-error">
															<label class="col-md-3 control-label">Auditeur <?php echo $inc; ?></label>
															<div class="col-md-4">
																<select name="A[]" class="select2me form-control">
																	...
																	$req1=$connexion->query("select * from Auditeur where id not in (select id_auditeur from auditeurprevu where numero_audit='$num')");
																	...
																	?>
																	 ...
																	 <select name="Au[]" class="select2me form-control">
...
<?php
	if (isset($_POST['valider3'])){
		...
		$Auditeur=$A[$innt];
		IF ($Au[$innt]=="A"){
		$add=$connexion->exec("INSERT INTO `auditeurprevu`(`id`, `id_auditeur`, `numero_audit`, `ann`, `fonction`) VALUES (null,'$Auditeur','$num',$ann,'2')");	
		}
		IF ($Au[$innt]=="O"){
		$add=$connexion->exec("INSERT INTO `auditeurprevu`(`id`, `id_auditeur`, `numero_audit`, `ann`, `fonction`) VALUES (null,'$Auditeur','$num',$ann,'3')");	
		}		
		$innt++;
									}
