			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						...
						<a href="javascript:;" id="Acc">Ajouter Auditeur</a>
							...
							<div class="tab-pane active" id="tab_2">
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-folder-o"></i>Nouvel Auditeur
										</div>
										<div class="tools">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="addauditeur.php" class="form-horizontal" method="post" ">
											<div class="form-body">
												...
												<div class="form-group has-error">
															...
															<div class="col-md-4">
																<select name="id" class="select2me form-control">
																	...
																	$ret=$obj1['nom'];
																	$ret2=$obj1['prenom'];
																		$filtre=$connexion->prepare("select id_utilisateur from auditeur where id_utilisateur=?");
																		$filtre->execute(array($id));
																		$compt=$filtre->rowcount();
																		if($compt==0){
...
if (isset($_POST['valider'])){
	...
	$selectuser=$connexion->query("select id, nom, prenom from utilisateur where utilisateur.id=$id");
	$userdetail = $selectuser->Fetch(PDO::FETCH_ASSOC);
	$id=$userdetail['id'];
	$nom=$userdetail['nom'];
	$prenom=$userdetail['prenom'];
	$addauditeur=$connexion->exec("INSERT INTO `auditeur` VALUES (null,'$nom','$prenom','$fonction',$q,$b,$id)");
