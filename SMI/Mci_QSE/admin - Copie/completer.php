  ...
  ob_start(null, 0, false);
	...
	$num=$_GET['num'];	
		...
		header("Location: 404.html");	
			...
			$compfiche=$connexion->exec("INSERT INTO `fichecompet` values (null,".$id_fiche.",".$reps1." ,".$reps2.")");
			if($compfiche!=0){						
			//mail
			...
			$txt = 'La fiche d\'audit n° '.$num.' est complétée par le responsable d\'audit<br>veuillez <a href="http://192.168.2.106:8080/SMI/Mci_QSE/admin/login.php">vous connecter</a> pour commenteraire et validation.
