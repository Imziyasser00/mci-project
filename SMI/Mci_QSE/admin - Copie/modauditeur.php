...
<title>MCI | Listes des auditeurs</title>
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-users"></i>Listes des auditeurs
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
							...
							<tbody>
							<?php include 'bd.php';
							$selectauditeur=$connexion->query("select id, nom, fonction, qse, bpf  from auditeur");
							...
							<tr>							
								...
								<td>
									 <center><a href="modauditeur0.php?id='.$id0.'">Modifier</a></center>
								</td>								
							</tr>';
							}
							?>
