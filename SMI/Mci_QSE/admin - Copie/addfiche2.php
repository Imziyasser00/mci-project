  ...
  ob_start(null, 0, false);
	...
	$num=$_GET['num'];	
		...
		if(isset($_POST['presenceouverture']) and $_POST['presenceouverture']!=''){
			...
			$creefiche=$connexion->exec("INSERT INTO `reunionouverture` values (null ,'".$date."' ,'".$time."','".$num."')");
			if($creefiche!=0){
				while ($monchoix = array_shift($presenceouverture)){				
				$result3=$connexion->exec("INSERT INTO `presenceouverture`  VALUES (null, '".$num."', ".$monchoix.")");
