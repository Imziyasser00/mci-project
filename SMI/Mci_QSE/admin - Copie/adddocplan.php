							...
							<div class="tab-pane active" id="tab_2">
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="adddocplan1.php" class="form-horizontal" method="post" enctype="multipart/form-data">
											<div class="form-body">
											...
											<div class="form-group has-error">
													...
													<div class="col-md-4">
														<div class="input-icon right">															
															<input type="text" name="nom" class="form-control" placeholder="Désignation" autocomplete="off">
														</div>
													</div>
												</div>									
														...
														<div class="form-group has-error">
															...
															<div class="col-md-4">
																<select name="ser" class="select2me form-control">
																	...
																	$n=$obj['nom'];
																	$idServe=$obj['id'];
																	echo '<option value="'.$idServe.'">'.utf8_encode($n).'</option>';
																	?>
										...
										<div class="col-md-5">
										<input class="form-control" id="mask_date" type="text" name="datepre" value=""/>
											<span class="help-block">
