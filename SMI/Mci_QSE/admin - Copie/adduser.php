										...
										<form action="insuser.php" class="form-horizontal" method='POST'>
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
														<div class="input-group">
															<input type="text" name="login" class="form-control input-circle-left" placeholder="" autocomplete="off">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<div class="input-group">
															<input type="text" name="mdp" class="form-control input-circle-left" placeholder="" autocomplete="off">
															<span class="input-group-addon input-circle-right">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<div class="input-icon right">															
															<input type="text" name="nom" class="form-control input-circle" placeholder="Nom" autocomplete="off">
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-4">
														<div class="input-icon right">
															...
															<input type="text" name="prenom" class="form-control input-circle" placeholder="Prenom" autocomplete="off">
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-4">
														<div class="input-icon right">
															...
															<input type="text" name="fonction" class="form-control input-circle" placeholder="Fonction" autocomplete="on">
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-4">
														<div class="input-icon right">
															...
															<input type="text" name="mail" class="form-control input-circle" placeholder="mail" autocomplete="on">
														</div>
													</div>
												</div>
