...
if (version_compare(PHP_VERSION, '5.4.0', '>=')) {
  ...
  ob_start(null, 0, false);
	...
	$num=$_GET['num'];		
include_once 'bd.php';	
$verification=$connexion->prepare("select * from fichdaudit where audit_num=? and id_RA=?");
$verification->execute(array($num,$id_ra));
$nbrv=$verification->rowcount();

if($nbrv==0){
	$test=$connexion->prepare("select  id from rapportcreeoupas where num=? and CreeOuPas=1");					
	...
	$delchamp=$connexion->prepare("DELETE FROM POINT where type='ameliorati' and numero_audit=?");
							...
							<div class="tab-pane active" id="tab_2">
								<div class="portlet box blue">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										 <form action="addRapportPA1.php?num=<?php echo $num ; ?>" class="form-horizontal" method="post" >
											<div class="form-body">			
													...
													<label class="control-label col-md-3"><b>Point à améliorer 1:</b></label><a href="#" onclick="toggle_visibility('PA2','vide2'),toggle_visibility2('ic1','ic2'),cleartext('text2');">
...
<label class="control-label col-md-3"><b>Points à améliorer 2 :</b></label><a href="#PA2" onclick="toggle_visibility('PA3','vide3'),toggle_visibility2('icplus2','icminus2'),cleartext('text3');">
...
<label class="control-label col-md-3"><b>Points à améliorer 3 :</b></label><a href="#PA3" onclick="toggle_visibility('PA4','vide4'),toggle_visibility2('icplus3','icminus3'),cleartext('text4');">
...
<label class="control-label col-md-3"><b>Points à améliorer 4 :</b></label><a href="#PA4" onclick="toggle_visibility('PA5','vide5'),toggle_visibility2('icplus4','icminus4'),cleartext('text5');">
...
<label class="control-label col-md-3"><b>Points à améliorer 5 :</b></label><a href="#PA5" onclick="toggle_visibility('PA6','vide6'),toggle_visibility2('icplus5','icminus5'),cleartext('text6');">
...
<label class="control-label col-md-3"><b>Points à améliorer 6 :</b></label><a href="#PA6" onclick="toggle_visibility('PA7','vide7'),toggle_visibility2('icplus6','icminus6'),cleartext('text7');">
...
<label class="control-label col-md-3"><b>Points à améliorer 7 :</b></label><a href="#PA7" onclick="toggle_visibility('PA8','vide8'),toggle_visibility2('icplus7','icminus7'),cleartext('text8');">
...
<label class="control-label col-md-3"><b>Points à améliorer 8 :</b></label><a href="#PA8" onclick="toggle_visibility('PA9','vide9'),toggle_visibility2('icplus8','icminus8'),cleartext('text9');">
...
<label class="control-label col-md-3"><b>Points à améliorer 9 :</b></label><a href="#PA9" onclick="toggle_visibility('PA10','vide10'),toggle_visibility2('icplus9','icminus9'),cleartext('text10');">
...
<label class="control-label col-md-3"><b>Points à améliorer 10 :</b></label><a href="#PA10" onclick="toggle_visibility('PA11','vide11'),toggle_visibility2('icplus10','icminus10'),cleartext('text11');">
...
<label class="control-label col-md-3"><b>Points à améliorer 11 :</b></label><a href="#PA11" onclick="toggle_visibility('PA12','vide12'),toggle_visibility2('icplus11','icminus11'),cleartext('text12');">
...
<label class="control-label col-md-3"><b>Points à améliorer 12 :</b></label><a href="#PA12" onclick="toggle_visibility('PA13','vide13'),toggle_visibility2('icplus12','icminus12'),cleartext('text13');">
...
<label class="control-label col-md-3"><b>Points à améliorer 13 :</b></label><a href="#PA13" onclick="toggle_visibility('PA14','vide14'),toggle_visibility2('icplus13','icminus13'),cleartext('text14');">
...
<label class="control-label col-md-3"><b>Points à améliorer 14 :</b></label><a href="#PA14" onclick="toggle_visibility('PA15','vide15'),toggle_visibility2('icplus14','icminus14'),cleartext('text15');">
...
<label class="control-label col-md-3"><b>Points à améliorer 15 :</b></label><a href="#PA15" onclick="toggle_visibility('PA16','vide16'),toggle_visibility2('icplus15','icminus15'),cleartext('text16');">
...
<label class="control-label col-md-3"><b>Points à améliorer 16 :</b></label><a href="#PA16" onclick="toggle_visibility('PA17','vide17'),toggle_visibility2('icplus16','icminus16'),cleartext('text17');">
...
<label class="control-label col-md-3"><b>Points à améliorer 17 :</b></label><a href="#PA17" onclick="toggle_visibility('PA18','vide18'),toggle_visibility2('icplus17','icminus17'),cleartext('text18');">
...
<label class="control-label col-md-3"><b>Points à améliorer 18 :</b></label><a href="#PA18" onclick="toggle_visibility('PA19','vide19'),toggle_visibility2('icplus18','icminus18'),cleartext('text19');">
...
<label class="control-label col-md-3"><b>Points à améliorer 19 :</b></label><a href="#PA19" onclick="toggle_visibility('PA20','vide20'),toggle_visibility2('icplus19','icminus19'),cleartext('text20');">
...
<label class="control-label col-md-3"><b>Points à améliorer 20 :</b></label><a href="#PA20" onclick="toggle_visibility('PA21','vide21'),toggle_visibility2('icplus20','icminus20'),cleartext('text21');">
...
<label class="control-label col-md-3"><b>Points à améliorer 21 :</b></label><a href="#PA21" onclick="toggle_visibility('PA22','vide22'),toggle_visibility2('icplus21','icminus21'),cleartext('text22');">
...
<label class="control-label col-md-3"><b>Points à améliorer 22 :</b></label><a href="#PA22" onclick="toggle_visibility('PA23','vide23'),toggle_visibility2('icplus22','icminus22'),cleartext('text23');">
...
<label class="control-label col-md-3"><b>Points à améliorer 23 :</b></label><a href="#PA23" onclick="toggle_visibility('PA24','vide24'),toggle_visibility2('icplus23','icminus23'),cleartext('text24');">
...
<label class="control-label col-md-3"><b>Points à améliorer 24 :</b></label><a href="#PA24" onclick="toggle_visibility('PA25','vide25'),toggle_visibility2('icplus24','icminus24'),cleartext('text25');">
...
<label class="control-label col-md-3"><b>Points à améliorer 25 :</b></label><a href="#PA25" onclick="toggle_visibility('PA26','vide26'),toggle_visibility2('icplus25','icminus25'),cleartext('text26');">
...
<label class="control-label col-md-3"><b>Points à améliorer 26 :</b></label><a href="#PA26" onclick="toggle_visibility('PA27','vide27'),toggle_visibility2('icplus26','icminus26'),cleartext('text27');">
...
<label class="control-label col-md-3"><b>Points à améliorer 27 :</b></label><a href="#PA27" onclick="toggle_visibility('PA28','vide28'),toggle_visibility2('icplus27','icminus27'),cleartext('text28');">
...
<label class="control-label col-md-3"><b>Points à améliorer 28 :</b></label><a href="#PA28" onclick="toggle_visibility('PA29','vide29'),toggle_visibility2('icplus28','icminus28'),cleartext('text29');">
...
<label class="control-label col-md-3"><b>Points à améliorer 29 :</b></label><a href="#PA29" onclick="toggle_visibility('PA30','vide30'),toggle_visibility2('icplus29','icminus29'),cleartext('text30');">
...
<label class="control-label col-md-3"><b>Points à améliorer 30 :</b></label><a href="#PA30" onclick="toggle_visibility('PA31','vide31'),toggle_visibility2('icplus30','icminus30'),cleartext('text31');">
...
<label class="control-label col-md-3"><b>Points à améliorer 31 :</b></label><a href="#PA31" onclick="toggle_visibility('PA32','vide32'),toggle_visibility2('icplus31','icminus31'),cleartext('text32');">
...
<label class="control-label col-md-3"><b>Points à améliorer 32 :</b></label><a href="#PA32" onclick="toggle_visibility('PA33','vide33'),toggle_visibility2('icplus32','icminus32'),cleartext('text33');">
...
<label class="control-label col-md-3"><b>Points à améliorer 33 :</b></label><a href="#PA33" onclick="toggle_visibility('PA34','vide34'),toggle_visibility2('icplus33','icminus33'),cleartext('text34');">
...
<label class="control-label col-md-3"><b>Points à améliorer 34 :</b></label><a href="#PA34" onclick="toggle_visibility('PA35','vide35'),toggle_visibility2('icplus34','icminus34'),cleartext('text35');">
...
<label class="control-label col-md-3"><b>Points à améliorer 35 :</b></label><a href="#PA35" onclick="toggle_visibility('PA36','vide36'),toggle_visibility2('icplus35','icminus35'),cleartext('text36');">
...
<label class="control-label col-md-3"><b>Points à améliorer 36 :</b></label><a href="#PA36" onclick="toggle_visibility('PA37','vide37'),toggle_visibility2('icplus36','icminus36'),cleartext('text37');">
...
<label class="control-label col-md-3"><b>Points à améliorer 37 :</b></label><a href="#PA37" onclick="toggle_visibility('PA38','vide38'),toggle_visibility2('icplus37','icminus37'),cleartext('text38');">
...
<label class="control-label col-md-3"><b>Points à améliorer 38 :</b></label><a href="#PA38" onclick="toggle_visibility('PA39','vide39'),toggle_visibility2('icplus38','icminus38'),cleartext('text39');">
...
<label class="control-label col-md-3"><b>Points à améliorer 39 :</b></label><a href="#PA39" onclick="toggle_visibility('PA40','vide40'),toggle_visibility2('icplus39','icminus39'),cleartext('text40');">
...
<label class="control-label col-md-3"><b>Points à améliorer 40 :</b></label>
<div class="col-md-6">
