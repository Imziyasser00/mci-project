...
if (isset($_POST['valider'])){
	...
	$selectuser=$connexion->query("select nom, prenom from utilisateur where utilisateur.id=$id");
	$userdetail = $selectuser->Fetch(PDO::FETCH_ASSOC);
	$nom=$userdetail['nom'];
	$prenom=$userdetail['prenom'];
	$addauditeur=$connexion->exec("INSERT INTO `auditeur`(`id`, `nom`, `prenom`, `fonction`, `qse`, `bpf`) VALUES (null,'$nom','$prenom','$fonction',$q,$b)");
