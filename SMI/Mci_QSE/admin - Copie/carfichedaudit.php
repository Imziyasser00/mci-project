				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							...
							<tbody>
							<?php include 'bd.php';
							$selectaudit=$connexion->query("select numero,sem,ann, id_service,id_sservice, ddatep, fdatep,duree  from auditprevu where sem=$sem and ann=$ann ");
...
elseif(isset($_POST['retour'])){
	header("Location: fichedaudit0.php");
}
 ?>
</html>