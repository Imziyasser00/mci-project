...
if (version_compare(PHP_VERSION, '5.4.0', '>=')) {
  ...
  ob_start(null, 0, false);
    ...
    elseif (!isset($_SESSION['nom']) and !isset($_POST['sem']) and !isset($_POST['ann'])) {
							...
							<div class="tab-pane active" id="tab_2">
								<div class="portlet box blue">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-file-o"></i>Fiche d'audit
										</div>
										<div class="tools">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="carfichedaudit.php" class="form-horizontal" method="post" >
											<div class="form-body">						
												
												
											<div class="form-group has-error">
															<label class="col-md-3 control-label">N° d'audit</label>
															<div class="col-md-4">
																<select name="sem" class="select2me form-control">
																	
																	<?php
																	include_once bd.php;
																	$req1=$connexion->query("select num from fichecreeoupas where sem='$sem' and annee='$ann' ");
																	$nbr=$req1->rowcount();
																	if($nbr!=0){
												...
												<div class="row">
													<div class="col-md-offset-3 col-md-9">
														...
														<button type="submit" name="retour" class="btn btn-circle default">Retour</button>
