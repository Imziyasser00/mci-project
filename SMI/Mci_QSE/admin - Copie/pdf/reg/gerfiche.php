...
<?php 
		...
		$req13=$connexion->query("select objectif from objectifaudit where num_audit='$num'");		
																	...
																	while  ($sectobj = $req13->Fetch(PDO::FETCH_ASSOC)) 
																	{
																	$objectif1=	utf8_encode($sectobj['objectif']);
																	$objectifs=str_replace('?', '\'', $objectifs); 
																	$objectif.='<li class="MsoNormal"><span lang="FR-CH">'.$objectif1.'</span></li>';																
																	}															
	...
	<?php $req1=$connexion->query("select id_sservice from auditprevu where numero='$num'");	
															...
															?>
	<?php 
				$selectauditeurprevu=$connexion->query('select id,id_auditeur, fonction,numero_audit  from auditeurprevu where auditeurprevu.numero_audit="'.$num.'" and fonction != 1 order by id');
...
<?php 
			...
			$rep1=utf8_encode($valcomp['reponse1']);
			$rep2=utf8_encode($valcomp['reponse2']);
  ...
  <tr>
	...
	<table border="2">
		<tr>
			...
			<td  width="140" align="center" rowspan="3">&nbsp;<br>&nbsp;<br><b>Management</b><br><b>QSE</b></td>       
		</tr>	
		<tr>        
		...
		<tr>        
			...
			<td  width="300" align="center" clspane="2"><b>FOR-QSE 032 c</b></td>              
		</tr>	
		<tr>
			<td align="center"><b>Page/pages</b></td>       
			<td align="center" width="150">01/01</td>       
			<td align="center" width="150"><b>Date d'application</b></td> 
			<td align="center" width="140">26/02/2018</td> 
		</tr>	
	</table>
	</td>
  </tr>
...
$entete='
  ...
  normal"><span>&nbsp;&nbsp;Date de l’audit&nbsp;:&nbsp; '. $num .' <o:p></o:p></span></p>
					</td>
		
					<td colspan="2" width="372">
					<p class="MsoNormal" style="margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal"><span>&nbsp;&nbsp;Responsable d’audit&nbsp;&nbsp;: &nbsp;&nbsp;'. $respname .'<o:p></o:p></span></p>
					</td>
				</tr>';
 $entete2 =	'<tr>
  ...
  0cm;margin-left:0cm;margin-bottom:.0001pt;line-height:normal"><span>&nbsp;&nbsp;Champ de 
					l’activité auditée&nbsp;&nbsp;: &nbsp;&nbsp;<b><i>'.sservice($sservicenom).' </i></b><o:p></o:p></span></p>
  ...
  justify;line-height:normal"><span>&nbsp;&nbsp;Objectifs de l’audit&nbsp;: </span>
					</p>
					<ul type="disc">
						'.$objectif.'
					</ul>
