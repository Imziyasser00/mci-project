...
<?php
	...
	$Sname=$objser['nom'];
	$num=$_GET['num'];
	$ficheid=$connexion->query("select id, id_RA from fichdaudit where audit_num='".$num."'");
...
<div class="page-container">
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					<li>
						<i class="fa fa-file-o"></i>
						<a href="javascript:;" id="Acc">Fiche n° </a>
				...
				<div class="page-toolbar">
					<div class="btn-group pull-right">
						...
						$tot1=$connexion->query('select * from fichecomqse where id_fiche="'.$id_fiche.'" and vop="1"');
						...
						$verif=$tot->rowcount();						
							...
							<?php 
								...
								?>
								<li>
								<a  data-toggle="dropdown" data-hover="dropdown" data-delay="1000" data-close-others="false">Diffusion
								</a>
								<ul>
								
									<li>
										<a href="fiche/diffusion.php?num=<?php echo $num; ?>">Diffusion par mail</a>
									</li>
							...
							<?php }
								...
								?>
							<li> <a class="btn btn-fit-height red dropdown-toggle"  href="audit/annulqse.php?id_fiche=<?php echo $id_fiche;?>&num=<?php echo $num;?>" data-toggle="modal" id="Acc">
			...
			<table border="1" cellpadding="0" cellspacing="0" class="MsoNormalTable" style="width: 541px; height: 137px">
				...
				<tr>
					...
					<td colspan="2" width="398">
					<p class="auto-style4" style="page-break-after: avoid;">
					<span>FOR-QSE 032 c<o:p></o:p></span></p>
					</td>
				</tr>
				<tr>
					<td width="142">
 ...
 mso-border-insidev:.5pt solid windowtext" width="660">
  ...
  0cm;margin-left:0cm;margin-bottom:.0001pt;line-height:normal"><span>&nbsp;&nbsp;Champ de 
					l’activité auditée&nbsp;&nbsp;: &nbsp;&nbsp;<b><i><?php echo sservice($sservicenom); ?></i></b><o:p></o:p></span></p>
  ...
  justify;line-height:normal"><span>&nbsp;&nbsp;Objectifs de l’audit&nbsp;: <o:p></o:p></span>
					...
					<?php $req13=$connexion->query("select objectif from objectifaudit where num_audit='$num'");	
																	$objobje=$req13->rowcount();
																	if($objobje!=0){
																	while  ($objobje = $req13->Fetch(PDO::FETCH_ASSOC)) 
																	{
																		
																		$objectif=$objobje['objectif'];	
																		$objectif=str_replace('?', '\'', $objectif); 
																	?>	
																<p align="center" class="MsoNormal" style="margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:left;line-height:normal"><b><i><span>&nbsp;&nbsp;-&nbsp;<?php echo utf8_encode($objectif); ?><o:p></o:p></span></i></b></p>
																	<?php }
																	}
															?>					
					<p class="MsoNormal" style="margin-top:6.0pt;margin-right:0cm;margin-bottom:
  ...
  line-height:normal"><b><i><span>&nbsp;&nbsp;<?php echo $idr;?><o:p></o:p></span></i></b></p>
				...
				<tr><?php 
				$selectauditeurprevu=$connexion->query('select id,id_auditeur, fonction,numero_audit  
  ...
  line-height:normal"><span>Les activités et résultats audités satisfont aux 
					...
					<p class="MsoNormal" style="mso-margin-bottom-alt:auto;text-align:justify;
  line-height:normal"><b><i><span><?php echo utf8_encode($rep1); ?>.<o:p></o:p></span></i></b></p>
					<p class="MsoNormal" style="mso-margin-bottom-alt:auto;text-align:justify;
  line-height:normal"><span>Ces dispositions sont mises en œuvre de façon 
				...
				<p class="MsoNormal" style="mso-margin-bottom-alt:auto;text-align:justify;
  line-height:normal"><b><i><span><?php echo utf8_encode($rep2); ?>.<o:p></o:p></span></i></b></p>
					</td>
				</tr>
				<tr>
					<td colspan="3" valign="top" width="660">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<form action="audit/addcom.php?num=<?php echo $num; ?>" method="post" class="form-horizontal form-bordered">
								...
								<div class="form-group has-error">
														<div class="col-md-11">
														<textarea id="maxlength_textarea" class="form-control" maxlength="225" rows="2"  name="reps1"><?php echo utf8_encode($rep3); ?></textarea>
															<span class="help-block">
															</span>
														</div>
									</div>							
					...
					<div class="modal-header">
						...
						<form action="audit/modconcusion.php?num=<?php echo $num; ?>" method="post" class="form-horizontal form-bordered">
								...
								<div class="form-group has-error">
													<label class="control-label col-md-13">Les activités et résultats audités satisfont aux dispositions préétablies ? </label>
													<div class="col-md-11">
														<textarea id="maxlength_textarea" class="form-control" maxlength="225" rows="2"  name="reps1"><?php echo utf8_encode($rep1); ?></textarea>
															<span class="help-block">
															</span>
														</div>
									</div>	
								...
								<div class="form-group has-error">
													<label class="control-label col-md-13">Les activités et résultats audités satisfont aux dispositions préétablies ?   </label>
													<div class="col-md-11">
														<textarea id="maxlength_textarea" class="form-control" maxlength="225" rows="2"  name="reps2"><?php echo utf8_encode($rep2); ?></textarea>
															<span class="help-block">
															</span>
														</div>
									</div>	
					...
					<div class="modal-header">
						...
						<form action="audit/modidr.php?num=<?php echo $num; ?>" method="post" class="form-horizontal form-bordered">
								...
								<div class="form-group has-error">
													...
													<div class="col-md-11">
														<textarea id="maxlength_textarea" class="form-control" maxlength="225" rows="2"  name="reps1"><?php echo $idr; ?></textarea>
															<span class="help-block">
															</span>
														</div>
									</div>	
