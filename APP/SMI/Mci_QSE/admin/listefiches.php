...
if (version_compare(PHP_VERSION, '5.4.0', '>=')) {
  ...
  ob_start(null, 0, false);
    ...
    if (!isset($_SESSION['nom']) || ($_SESSION['adp']!=2 and $_SESSION['adp']!=1)) {
...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
           ...
           <!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			<center><span class="auto-style3"><font color="#0B6294">S</span><span class="auto-style2">ystème <b>M</b>anagement <b>I</b>ntégré</font></span><br>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box grey-cascade">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-file-o"></i>Liste des Fiches Créées
                            </div>
                        ...
                        <div class="portlet-body">
                            ...
                            <tbody>
                                ...
                                <?php
                                include_once 'bd.php';
                                $selectFiche=$connexion->query("select * from fichecreeoupas where CreeOuPas=1");
                                $nbra = $selectFiche->rowcount();
                                if($nbra!=0){

                                while  ($obj = $selectFiche->Fetch(PDO::FETCH_ASSOC))
                                {
                                    $num=$obj['num'];
                                    $idRA=$obj['i_RA'];
                                    //nom processus
							...
							$sel = $selidauditeur->Fetch(PDO::FETCH_ASSOC);
                                ...
                                echo '<tr class="odd gradeX"><td>'.$num.'</td>';
                                echo '<td>'.$sservicenom.'</td>';
								echo '<td>'.$audnom=$sel['nom'].' '.$audprenom=$sel['prenom'].'</td>';
								echo '<td><a href="addfiche5.php?num='.$num.'">Fiche</a></td>';	
							}
							}
							}
							}
