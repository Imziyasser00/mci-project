                                ...
                                <div class="tab-pane active" id="tab_2">
                                    <div class="portlet box green">
                                        ...
                                        <div class="portlet-body form">
                                            <!-- BEGIN FORM-->
                                            <form action="adddoc.php" class="form-horizontal" method="post"
                                                            ...
                                                            <div class="fileinput fileinput-new"
                                                                ...
                                                                <div class="input-group input-large">
                                                                    <div class="form-control uneditable-input span3"
                                                                        ...
                                                                        <i
                                                                            class="fa fa-file fileinput-exists"></i>&nbsp;
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <select name="etat" class="select2me form-control">
                                                                ...
                                                                <option value="En cours d'application">En cours
                                                                    d'application</option>
                                                                <option value="En cours de révision">En cours de
                                                                    révision</option>
	...
	if( $FileType != "pdf" && $FileType != "PDF") {      
       ...
       alert("Seuls les fichiers de type PDF sont autorisés");</script>';	
		...
		if (move_uploaded_file($filetemp, $target_file)) {			
			...
			$result=$connexion->exec("INSERT INTO Document VALUES('','$r2',$file_name,'$type','$FileType',$target_file,$r3,'$app','$ravi',$adp)");
			if($result!=0){
