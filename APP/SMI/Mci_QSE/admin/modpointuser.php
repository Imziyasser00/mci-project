...
$show=0;
if(isset($_SESSION['nom']) and isset($_GET['pid']) and isset($_GET['num']) and isset($_GET['an']) and isset($_GET['idproc'])){
	$show=1;
		$pid=$_GET['pid'];
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<!-- BEGIN EXAMPLE TABLE PORTLET-->
					 <form action="modpointuser1.php?pid=<?php echo $pid ; ?>&num=<?php echo $num ; ?>&an=<?php echo $an ; ?>&idproc=<?php echo $idproc ; ?>" class="form-horizontal" method="post" >
