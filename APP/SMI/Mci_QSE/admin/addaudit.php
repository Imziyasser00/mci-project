...
if (isset($_POST['valider2'])){
	...
	$to=$_POST['to'];
	$addRA=$connexion->exec("INSERT INTO `auditeurprevu`(`id`, `id_auditeur`, `numero_audit`,`ann`, `fonction`) VALUES ('','$RA','$num',$ann,'1')");
	$addA=$connexion->exec("INSERT INTO `auditeurprevu`(`id`, `id_auditeur`, `numero_audit`, `ann`, `fonction`) VALUES ('','$A','$num',$ann,'2')");
	$addO=$connexion->exec("INSERT INTO `auditeurprevu`(`id`, `id_auditeur`, `numero_audit`, `ann`, `fonction`) VALUES ('','$O','$num',$ann,'3')");
	...
	$addauditp=$connexion->exec("INSERT INTO auditprevu VALUES ('',$ann,'$num','$duree',$idt,$idss,'$from','$to')");
