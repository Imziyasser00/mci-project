...
if($nbra==0 and valide($id_ra,$num)!=0){
	...
	$delchamp=$connexion->prepare("DELETE FROM POINT where type='fort' and numero_audit=?");
							...
							<div class="tab-pane active" id="tab_2">
								<div class="portlet box blue">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										 <form action="addRapportPF.php?num=<?php echo $num ; ?>" class="form-horizontal" method="post" >
											<div class="form-body">			
													...
													<label class="control-label col-md-3"><b>Point fort 1 :</b></label><a href="#" onclick="toggle_visibility('foo','foo2'),toggle_visibility2('ic1','ic2'),cleartext('text1');">
													...
													<div class="form-group has-error" id="foo2" style="display:none">
															<label class="control-label col-md-3"><b>Point fort 2 :</b></label><a href="#" onclick="toggle_visibility('foo3','foo4'),toggle_visibility2('ic3','ic4'),cleartext('text2');">
													...
													<div class="form-group has-error" id="foo4" style="display:none">
															<label class="control-label col-md-3"><b>Point fort 3 :</b></label><a href="#" onclick="toggle_visibility('foo5','foo6'),toggle_visibility2('ic5','ic6'),cleartext('text3');">
													...
													<div class="form-group has-error" id="foo6" style="display:none">
															<label class="control-label col-md-3"><b>Point fort 4 :</b></label><a href="#" onclick="toggle_visibility('foo7','foo8'),toggle_visibility2('ic7','ic8'),cleartext('text4');">
													...
													<div class="form-group has-error" id="foo8" style="display:none">
															<label class="control-label col-md-3"><b>Point fort 5 :</b></label>
