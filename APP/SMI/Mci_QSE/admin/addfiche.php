										...
										<!-- BEGIN FORM-->
										 <form action="addfiche0.php?num=<?php echo $num ; ?>" class="form-horizontal" method="post" >
											<div class="form-body">			
												...
												<div class="form-group has-error">
															<label class="col-md-3 control-label">Activitée auditée : </label>
...
if (isset($_POST['from'])){
	...
	$addRA=$connexion->exec("INSERT INTO `auditeurprevu`(`id`, `id_auditeur`, `numero_audit`, `sem`, `ann`, `fonction`) VALUES ('','$RA','$num',$sem,$ann,'1')");
	$addA=$connexion->exec("INSERT INTO `auditeurprevu`(`id`, `id_auditeur`, `numero_audit`, `sem`, `ann`, `fonction`) VALUES ('','$A','$num',$sem,$ann,'2')");
	$addO=$connexion->exec("INSERT INTO `auditeurprevu`(`id`, `id_auditeur`, `numero_audit`, `sem`, `ann`, `fonction`) VALUES ('','$O','$num',$sem,$ann,'3')");
