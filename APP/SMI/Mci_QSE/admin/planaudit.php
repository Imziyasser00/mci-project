                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="portlet-body form">
                                <form action="pdf/reg/gerplananuel0.php" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <button id="sample_editable_1_new" class="btn green"
                                            onClick="parent.location='confirmplan.php?sem=<?php echo $sem; ?>&ann=<?php echo $ann; ?>'">
                                ...
                                <div class="col-md-3">
                                    <div class="btn-group">
                                        <button id="sample_editable_1_new" class="btn red"
                                            onClick="parent.location='annulconfirmplan.php?sem=<?php echo $sem; ?>&ann=<?php echo $ann; ?>'">
                                ...
                                <div class="col-md-6">
                                    <div class="btn-group pull-right">
                                        <button class="btn dropdown-toggle" data-toggle="dropdown">Enregistrer <i
