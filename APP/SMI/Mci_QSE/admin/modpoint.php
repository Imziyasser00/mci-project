		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<!-- BEGIN EXAMPLE TABLE PORTLET-->
					 <form action="modpoint1.php?pid=<?php echo $pid ; ?>&idproc=<?php echo $idproc ; ?>&ann=<?php echo $ann ; ?>" class="form-horizontal" method="post" >
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							...
							<?php include 'bd.php';															
								...
								//date
								$selectdate=$connexion->query('select date from rapportcreeoupas where rapportcreeoupas.audit_num="'.$numero.'"');
							...
							<tr>							
								...
								<td valign="middle">
								 <center><br><input class="form-control" type="text" value="'.$resp.'" name="resp"></input></center>
								</td>
								<td valign="middle">
								 <center><br>
								 <select name="acap" class="select2me form-control">
								...
								<td valign="middle">
								<center><br><textarea  class="form-control" maxlength="225" rows="2"  name="remarque">'.$remarque.'</textarea></center>
								</td>';						
								}	
								}
								}
