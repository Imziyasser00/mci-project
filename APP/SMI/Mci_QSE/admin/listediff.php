                                ...
                                <div class="tab-pane active" id="tab_2">
                                    <div class="portlet box green">
                                        ...
                                        <div class="portlet-body form">
                                            <!-- BEGIN FORM-->
                                            <form action="listediff.php" class="form-horizontal" method="post">
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group has-error">
                                                        <label class="col-md-3 control-label">Sous services</label>
                                                        <div class="col-md-4">
                                                            <select name="ser" class="select2me form-control">
                                                                <?php
																	include_once 'bd.php';
																	$req1=$connexion->query("select * from sservice order by id_service");
																	$nbr=$req1->rowcount();
																	if($nbr!=0){
																	...
																	$n=$obj['nom'];
																	$t=$obj['id'];
																	echo '<option value="'.$t.'">'.utf8_encode($n).'</option>';
																	?>
...
if(isset($_POST['valider'])){
	if(isset($_POST['ser'])){
		...
		$serpost=$_POST['ser'];		
		header("Location: diffselected.php?ser=$serpost");
