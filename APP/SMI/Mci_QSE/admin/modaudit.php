...
$show=0;
if(isset($_SESSION['nom']) and isset($_GET['sem']) and isset($_GET['ann'])){
	$show=1;
	$sem=$_GET['sem'];
		$ann=$_GET['ann'];
}
   if (isset($_SESSION['nom']) and isset($_POST['sem']) and isset($_POST['ann'])) {
       $sem=$_POST['sem'];
		$ann=$_POST['ann'];
		 $show=1;
    }
			...
			<div class="modal fade" id="portlet-config" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<form action="pdf/reg/gerplananuel.php" method="post" class="form-horizontal form-bordered">
								<div class="form-body">								
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-users"></i>Modification des Audits
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
							...
							<tbody>
							<?php include 'bd.php';
							$selectaudit=$connexion->query("select id,numero,sem,ann, id_service,id_sservice, ddatep, fdatep,duree  from auditprevu where sem=$sem and ann=$ann ");
							...
							<tr>							
								...
								<td>
									 <center><br><a href="mdaudit0.php?id='.$idau.'">Modifier</a></center>
								</td>								
							</tr>';
							}
							?>
