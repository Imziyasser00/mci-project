...
if($nbra==0 and valide($id_ra,$num)!=0){
	...
	$delchamp=$connexion->prepare("DELETE FROM diffusionaudit where numero_audit=?");
							...
							<div class="tab-pane active" id="tab_2">
								<div class="portlet box blue">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										 <form action="addRapportdiff1.php?num=<?php echo $num ; ?>" class="form-horizontal" method="post" >
											<div class="form-body">			
											...
											<div class="form-group has-error">
															...
															<div class="col-md-4">
																<select multiple="multiple" class="multi-select" id="my_multi_select1" name="monchoix[]">
																	<?php
																	include_once 'bd.php';
																	$req2=$connexion->query("select id, prenom, nom from utilisateur order by id_service");
