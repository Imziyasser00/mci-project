...
if (version_compare(PHP_VERSION, '5.4.0', '>=')) {
  ...
  ob_start(null, 0, false);
    ...
    if (!isset($_SESSION['nom'])) {
		...
		if (!isset($_GET['service']) || !isset($_GET['type']) || !isset($_GET['file']) || !isset($_GET['exp'])){
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
	<i class="fa fa-warning"></i><?php if($_GET['exp']==0){?>Ce document a éxpiré<?php } ?>
							</div>
							<div class="tools">
