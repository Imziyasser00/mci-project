							...
							<div class="tab-pane active" id="tab_2">
								<div class="portlet box blue">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-folder-o"></i>Listes des fiches d'audits
										</div>
										<div class="tools">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="addfiche5.php" class="form-horizontal" method="get" >
											<div class="form-body">						
												...
												<div class="form-group has-error">
															...
															<div class="col-md-4">
																<select name="num" class="select2me form-control">
																	...
																	{
																	$n=$obj['numero_audit'];			
																	$req2=$connexion->query("select num from fichecreeoupas where CreeOuPas=1 and num='".$n."'");
