			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						...
						<a href="adduser.php" id="Acc">Ajouter Utilisateur</a>
				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-file-o"></i>Liste des Utilisateurs
							</div>
							<div class="tools">
						...
						<?php			
								include_once 'bd.php';
								$req1=$connexion->query("select utilisateur.id as id, utilisateur.username as username, utilisateur.fonction as fonction,utilisateur.nom as nom,utilisateur.prenom as prenom,service.nom as serv from utilisateur,service where utilisateur.id_service=service.id");
								$nbr=$req1->rowcount();
								...
								{
									$id_u=$obj['id'];
								echo " <tr><td>".$obj['username']."</td><td>".$obj['nom']."</td><td>". $obj['prenom']."</td><td>".utf8_encode($obj['serv'])."</td><td>".utf8_encode($obj['fonction'])."</td>";
								echo '<td> <a href="moduser.php?id='.$id_u.'" class="fancybox fancybox.iframe" >Modifier</a>								
								<a href="deluser.php?id='.$id_u.'" onclick="return(confirm(\'Etes-vous sûr de vouloir supprimer ?\'))"; id="Acc" title="Supprimer"><span class="fa fa-trash-o"></span></a>';
