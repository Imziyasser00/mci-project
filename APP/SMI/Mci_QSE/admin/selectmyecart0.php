							...
							<div class="tab-pane active" id="tab_2">
								<div class="portlet box blue">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-folder-o"></i>Listes des audits
										</div>
										<div class="tools">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="selectmyecart0.php" class="form-horizontal" method="get" >
											<div class="form-body">						
												...
												<div class="form-group has-error">
															<label class="col-md-3 control-label">Fiche d'écart  n°</label>
															<div class="col-md-4">
																<select name="num_fiche" class="select2me form-control">
																	
																	<?php
																	$num_audit=$_POST['num'];
																	include_once 'bd.php';
																	$req1=$connexion->query("select num from fichedecart where id_RA=$idauditeur and audit_num='$num_audit'");
																	$nbr=$req1->rowcount();
																	if($nbr!=0){
