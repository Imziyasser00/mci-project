...
if (version_compare(PHP_VERSION, '5.4.0', '>=')) {
  ...
  ob_start(null, 0, false);
	...
	$prp = $connexion->prepare("DELETE FROM reunionouverture WHERE numero=?");
	$prp2 = $connexion->prepare("DELETE FROM presenceouverture WHERE num_audit=?");
				...
				<div class="col-md-12">
					<div class="tabbable tabbable-custom boxless tabbable-reversed">
							...
							<div class="tab-pane active" id="tab_2">
								<div class="portlet box blue">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										 <form action="addfiche2.php?num=<?php echo $num ; ?>" class="form-horizontal" method="post" >
											<div class="form-body">			
												
												
												<label><b>Réunion d’ouverture :</b></label>
						<div class="form-group has-error">
										<label class="control-label col-md-3">Date</label>
										<div class="col-md-4">
											<input class="form-control" id="mask_date" type="text" name="dateo"/>
						...
						<div class="form-group  has-error">
										...
										<div class="col-md-3">
											<div class="input-group">
												<input type="text" id="clockface_2" value="14:45" name="time" class="form-control" readonly=""/>
						...
						<div class="form-group has-error">
															...
															<div class="col-md-4">
																<select multiple="multiple" class="multi-select" id="my_multi_select2" name="presenceouverture[]">
																	<?php
																	include_once 'bd.php';
												...
												<div class="row">
													<div class="col-md-offset-3 col-md-9">
														...
														<button type="submit" name="back" class="btn btn-circle default">Précedent  </button>
														<button type="submit" name="suivant" class="btn btn-circle blue">Suivant</button>
													</div>
												</div>
													<div class="col-md-6">
													</div>
...
if (isset($_POST['from'])){
	...
	$addRA=$connexion->exec("INSERT INTO `auditeurprevu`(`id`, `id_auditeur`, `numero_audit`, `sem`, `ann`, `fonction`) VALUES ('','$RA','$num',$sem,$ann,'RA')");
	$addA=$connexion->exec("INSERT INTO `auditeurprevu`(`id`, `id_auditeur`, `numero_audit`, `sem`, `ann`, `fonction`) VALUES ('','$A','$num',$sem,$ann,'A')");
	$addO=$connexion->exec("INSERT INTO `auditeurprevu`(`id`, `id_auditeur`, `numero_audit`, `sem`, `ann`, `fonction`) VALUES ('','$O','$num',$sem,$ann,'O')");
	if($_POST['idsup']!='vide' and $_POST['fonctionsup']!='vide'){
		$idsup=$_POST['idsup'];
		$fsup=$_POST['fonctionsup'];
	$addRA=$connexion->exec("INSERT INTO `auditeurprevu`(`id`, `id_auditeur`, `numero_audit`, `sem`, `ann`, `fonction`) VALUES ('','$idsup','$num',$sem,$ann,'$fsup')");
	}
	$addauditp=$connexion->exec("INSERT INTO auditprevu VALUES ('',$sem,$ann,'$num','$duree',$idt,$idss,'$from','$to')");
