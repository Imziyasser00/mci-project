							...
							<div class="tab-pane active" id="tab_2">
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-folder-o"></i>Choix de document 
										</div>
										<div class="tools">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="moddiff.php" class="form-horizontal" method="post">
											<div class="form-body">
														...
														<div class="form-group has-error">
															...
															<div class="col-md-7">
																<select name="ser" class="select2me form-control">
																	<?php
																	include_once bd.php;
																	$req1=$connexion->query("select * from document where document.ajtpar = $adp order by id_service ");
																	$nbr=$req1->rowcount();
																	if($nbr!=0){
...
if(isset($_POST['valider'])){
	if(isset($_POST['ser'])){
		$serpost=$_POST['ser'];
				...
				$result2=$connexion->query("select document.type as rtype from document where document.id=$serpost");
				if($result2!=NULL){
					$obj = $result2->Fetch(PDO::FETCH_ASSOC);					
					$rtype=$obj['rtype'];
				}
				
		header("Location: adddiff.php?file=$serpost&type=$rtype");
