...
if (version_compare(PHP_VERSION, '5.4.0', '>=')) {
  ...
  ob_start(null, 0, false);
	...
	$test->execute(array($num));							
		...
		$prp = $connexion->prepare("DELETE FROM reunioncloture WHERE numero=?");
	$prp2 = $connexion->prepare("DELETE FROM presencecloture WHERE num_audit=?");
				...
				<div class="col-md-12">
					<div class="tabbable tabbable-custom boxless tabbable-reversed">
							...
							<div class="tab-pane active" id="tab_2">
								<div class="portlet box blue">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										 <form action="addfiche4.php?num=<?php echo $num ; ?>" class="form-horizontal" method="post" >
											<div class="form-body">			
												
												
												<label><b>Réunion de clôture  :</b></label>
						...
						<div class="form-group has-error">
															...
															<div class="col-md-4">
																<select multiple="multiple" class="multi-select" id="my_multi_select2" name="reunioncloture[]">
																	<?php
																	include_once 'bd.php';
