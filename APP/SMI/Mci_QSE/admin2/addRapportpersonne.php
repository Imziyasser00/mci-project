...
if($nbra==0 and valide($id_ra,$num)!=0){
	...
	$delchamp=$connexion->prepare("DELETE FROM auditeefinal where  numero_audit=?");
							...
							<div class="tab-pane active" id="tab_2">
								<div class="portlet box blue">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										 <form action="addRapportpersonne1.php?num=<?php echo $num ; ?>" class="form-horizontal" method="post" >
											<div class="form-body">			
												
											<div class="form-group has-error">
															<label class="control-label col-md-3">Personnes auditées :  </label>
															<div class="col-md-4">
																<select multiple="multiple" class="multi-select" id="my_multi_select1" name="monchoix[]">
																	<?php
																	include_once 'bd.php';
																	$selectauditee=$connexion->query('select id, id_utilisateur ,num_audit  from auditee where auditee.num_audit="'.$num.'" order by id');
																	
																	$auditees1=$selectauditee->rowcount();
																	if($auditees1!=0){
																	...
																	echo '<option value="'.$r3.'">'.$audites['complet'].'</option>';
																	?>																	
																	 <?php } } ?>
																	 </select>
