...
if($nbra==0 and valide($id_ra,$num)!=0){
	...
	$delchamp=$connexion->prepare("DELETE FROM POINT where type='ecart maje' and numero_audit=?");
							...
							<div class="tab-pane active" id="tab_2">
								<div class="portlet box blue">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										 <form action="addRapportEM1.php?num=<?php echo $num ; ?>" class="form-horizontal" method="post" >
											<div class="form-body">			
													...
													<label class="control-label col-md-3"><b>Ecart majeur 1 :</b></label><a href="#" onclick="toggle_visibility('foo','foo2'),toggle_visibility2('ic1','ic2'),cleartext('text1');">
													...
													<div class="form-group has-error" id="foo2" style="display:none">
															<label class="control-label col-md-3"><b>Ecart majeur 2 :</b></label><a href="#" onclick="toggle_visibility('foo3','foo4'),toggle_visibility2('ic3','ic4'),cleartext('text2');">
													...
													<div class="form-group has-error" id="foo4" style="display:none">
															<label class="control-label col-md-3"><b>Ecart majeur 3 :</b></label><a href="#" onclick="toggle_visibility('foo5','foo6'),toggle_visibility2('ic5','ic6'),cleartext('text3');">
													...
													<div class="form-group has-error" id="foo6" style="display:none">
															<label class="control-label col-md-3"><b>Ecart majeur 4 :</b></label><a href="#" onclick="toggle_visibility('foo7','foo8'),toggle_visibility2('ic7','ic8'),cleartext('text4');">
													...
													<div class="form-group has-error" id="foo8" style="display:none">
															<label class="control-label col-md-3"><b>Ecart majeur 5 :</b></label><a href="#" onclick="toggle_visibility('foo9','foo10'),toggle_visibility2('ic9','ic10'),cleartext('text5');">
													...
													<div class="form-group has-error" id="foo10" style="display:none">
															<label class="control-label col-md-3"><b>Ecart majeur 6 :</b></label><a href="#" onclick="toggle_visibility('foo12','foo11'),toggle_visibility2('ic11','ic12'),cleartext('text6');">
													...
													<div class="form-group has-error" id="foo12" style="display:none">
															<label class="control-label col-md-3"><b>Ecart majeur 7 :</b></label>
