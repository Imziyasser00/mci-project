				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="../uploads/mmi.php" method="post" enctype="multipart/form-data">								
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<i class="fa fa-file-o"></i>
						<a href="javascript:;" id="Acc">Manuel Management Integre</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<i class="fa fa-eye"></i>
						<a href="../Documents/Manuel Management Integre/Manuel Management Integre.pdf" target="_blank" id="Acc">Visualiser</a>
		...
		<form class="acc-page">
			<div class="acc-page" style="height: 484px">
				...
				<div id="fich1" > 
				<object data="../Documents/Manuel Management Integre/Manuel Management Integre.pdf" type="text/html" codetype="application/pdf" style="width: 581px; height: 392px" ></object> 
				</div> 
