		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<i class="fa fa-cog"></i>
						<a href="javascript:;" id="Acc">Gestion des auditeurs</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<i class="fa fa-minus"></i>
						<a href="javascript:;" id="Acc">Supprimer Auditeur</a>
							...
							<div class="tab-pane active" id="tab_2">
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-trash-o"></i>Supprimer un Auditeur
										</div>
										<div class="tools">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="delauditeur.php" class="form-horizontal" method="post" ">
											<div class="form-body">
												...
												<div class="form-group has-error">
															<label class="col-md-3 control-label">Choix d'auditeur</label>
															<div class="col-md-4">
																<select name="nom" class="select2me form-control">
																	<?php
																	include_once 'bd.php';
																	$req2=$connexion->query("select id, prenom, nom from auditeur order by nom");
																	$nbr1=$req2->rowcount();
																	if($nbr1!=0){
																	...
																	$ret=$obj1['nom'];
																	$ret2=$obj1['prenom'];
																	echo '<option value="'.$ret.'">'.$ret.' '.$ret2.'</option>';
																	?>
												...
												<div class="row">
													<div class="col-md-offset-3 col-md-9">														
														<button type="submit" name="valider" class="btn btn-circle blue">Supprimer   </button>
...
if (isset($_POST['valider'])){
	...
	$nom=$_POST['nom'];
	$prenom=$_POST['prenom'];		
	$delauditeur=$connexion->query("DELETE from auditeur where auditeur.id=$id");	
	if($delauditeur!=NULL){
		header('Location: listeaudit.php');
	}
else{
	header('Location: 404.html');
	// 
