				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title">Informations complémentaires</h4>
						</div>
						<div class="portlet-body form">
						<form action="pdf/reg/gerplananuel0.php" method="post" class="form-horizontal form-bordered">
								<div class="form-body">								
								<div class="form-group">
									<label class="control-label col-md-6">Date de rédaction</label>
										<div class="col-md-4">
											<input class="form-control" id="mask_date2" type="text" name="Dred"/>
								...
								<div class="form-group">
									<label class="control-label col-md-6">Date de Vérification</label>
										<div class="col-md-4">
											<input class="form-control" id="mask_date2" type="text" name="Drev"/>
											<span class="help-block">
											m/j/aaaa </span>
										</div>
								</div>
								<div class="form-group">
									<label class="control-label col-md-6">Date d'Approbation</label>
										<div class="col-md-4">
											<input class="form-control" id="mask_date2" type="text" name="DApp"/>
											<span class="help-block">
											m/j/aaaa </span>
										</div>
								</div>								
								...
								<input type="hidden" value="<?php echo $_POST['ann'];?>" name="ann"/>
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-users"></i>Plan annuel d'audite interne
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								...
								<?php
									...
									<div class="col-md-6">
										<div class="btn-group">
											<button id="sample_editable_1_new" class="btn green" onClick="parent.location='confirmplan.php?sem=<?php echo $sem; ?>&ann=<?php echo $ann; ?>'" >
									...
									<div class="col-md-3">
										<div class="btn-group">
											<button id="sample_editable_1_new" class="btn red" onClick="parent.location='annulconfirmplan.php?sem=<?php echo $sem; ?>&ann=<?php echo $ann; ?>'" >
									...
									*/}
									...
									<div class="col-md-6">
										...
										<button class="btn dropdown-toggle" data-toggle="dropdown">Enregistrer <i class="fa fa-angle-down"></i>
										</button>
										<ul class="dropdown-menu pull-right">
											
											<li>
												<a href="#portlet-config" data-toggle="modal" class="config" id="Acc">
												PDF </a>
											</li>
											<li>
												<a href="#">
							...
							<tbody>
							<?php include 'bd.php';
							$selectaudit=$connexion->query("select numero,sem,ann, id_service,id_sservice, ddatep, fdatep,duree  from auditprevu where ann=$ann ");
										...
										$auditeurselect = $SelectAuditeurPrevuNom->Fetch(PDO::FETCH_ASSOC);
											$auditeurs['nom']=$auditeurselect['nom'];
												$auditeurs['prenom']=$auditeurselect['prenom'];
													...
													$list.=' <b> '.$auditeurs['fonction'].'</b> :'.$auditeurs['complet'].'<br> ';
								}
