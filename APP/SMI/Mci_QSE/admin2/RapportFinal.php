...
function valide($id1,$num){
  ...
  if (valide($id_session,$num)==0 and $testeur!=1 and $adp!=1 and $adp!=2){
	  header("Location: 404.html");
  }	
else{
	$nbrv=0;
		...
		<div id="foo2" style="display:block">
			...
			<table border="1" cellpadding="0" cellspacing="0" class="MsoNormalTable" width="639">
				<tr>
					...
					<p class="MsoNormal">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $ssnom; ?></p>
				...
				<tr>
					...
					<td colspan="2" width="213">
					<p align="center" class="MsoNormal"><span lang="FR-CH"><?php echo $fct; ?></span></p>
					</td>
				</tr>
				<tr>
