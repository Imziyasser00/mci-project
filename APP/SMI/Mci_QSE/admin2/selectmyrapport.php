												...
												<div class="form-group has-error">
															...
															<div class="col-md-4">
																<select name="num" class="select2me form-control">
																	...
																	$req1=$connexion->query("select numero_audit from auditeurprevu where id_auditeur=$idauditeur1");
																	...
																	{
																	$n=$obj['audit_num'];
																	$req2=$connexion->query("select audit_num from rapportcreeoupas where cop=1");
																	...
																	echo '<option value="">Aucun audit</option>';	
																	}
