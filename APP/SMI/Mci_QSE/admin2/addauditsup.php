...
<?php
	if (isset($_POST['valider3'])){
		...
		$Auditeur=$A[$innt];
		IF ($Au[$innt]=="A"){
		$add=$connexion->exec("INSERT INTO `auditeurprevu`(`id`, `id_auditeur`, `numero_audit`, `ann`, `fonction`) VALUES ('','$Auditeur','$num',$ann,'2')");	
		}
		IF ($Au[$innt]=="O"){
		$add=$connexion->exec("INSERT INTO `auditeurprevu`(`id`, `id_auditeur`, `numero_audit`, `ann`, `fonction`) VALUES ('','$Auditeur','$num',$ann,'3')");	
		}		
		$innt++;
									}
