...
<html lang="fr"> 
 <?php
	...
	$id=$_GET['id'];
	$cnx=$connexion->query("select * from utilisateur WHERE utilisateur.id=$id");
	$tab = $cnx->Fetch(PDO::FETCH_ASSOC);
	$Unom=$tab['nom'];
	$Uciv=$tab['civ'];
	$Uprenom=$tab['prenom'];
	$Usfonction=$tab['fonction'];
	$Usmail=$tab['mail'];
	$Uservice=$tab['id_service'];
	$Uuser=$tab['username'];
	$Umdp=$tab['mdp'];
	$ser=$connexion->query("select nom from service where service.id=$Uservice");
							...
							<div class="tab-pane active" id="tab_0">
								<div class="portlet box green">
									...
									<div class="portlet-body form">
										...
										<form action="upuser.php" class="form-horizontal" method='POST'>
											<div class="form-body">
												<div class="form-group">
													<label class="col-md-3 control-label">Identifiant</label>
													<div class="col-md-4">
														<div class="input-group">
															<input type="text" name="login" class="form-control input-circle-left" Value="<?php echo $Uuser; ?>">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<div class="input-group">
															<input type="password" name="mdp" class="form-control input-circle-left" Value="<?php echo $Umdp; ?>">
															<span class="input-group-addon input-circle-right">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<div class="input-icon right">															
															<input type="text" name="nom" Value="<?php echo $Unom; ?>" class="form-control input-circle" placeholder="Nom">
															<input type="hidden" name="civ" Value="<?php echo $Uciv; ?>">
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-4">
														<div class="input-icon right">
															...
															<input type="text" name="prenom" class="form-control input-circle" Value="<?php echo $Uprenom; ?>">
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-4">
														<div class="input-icon right">
															...
															<input type="text" name="Fonction" class="form-control input-circle" Value="<?php echo $Usfonction; ?>">
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-4">
														<div class="input-icon right">
															...
															<input type="text" name="mail" class="form-control input-circle" Value="<?php echo $Usmail; ?>">
														</div>
													</div>
												</div>													
...
<?php
	...
	echo '<script language="javascript" type="text/javascript">
       alert("Utilisateur Modifié avec succée");</script>';
	}
	elseif($_GET['cs']==2){
