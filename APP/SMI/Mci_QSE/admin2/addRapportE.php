										...
										<!-- BEGIN FORM-->
										 <form action="addRapportE1.php?num=<?php echo $num ; ?>" class="form-horizontal" method="post" >
											<div class="form-body">			
													...
													<label class="control-label col-md-3"><b>Ecart mineur 1 :</b></label><a href="#" onclick="toggle_visibility('foo','foo2'),toggle_visibility2('ic1','ic2'),cleartext('text1');">
													...
													<div class="form-group has-error" id="foo2" style="display:none">
															<label class="control-label col-md-3"><b>Ecart mineur 2 :</b></label><a href="#3" onclick="toggle_visibility('foo3','foo4'),toggle_visibility2('ic3','ic4'),cleartext('text2');">
													...
													<div class="form-group has-error" id="foo4" style="display:none">
															<label class="control-label col-md-3"><b>Ecart mineur 3 :</b></label><a href="#4" onclick="toggle_visibility('foo5','foo6'),toggle_visibility2('ic5','ic6'),cleartext('text3');">
																<i class="fa fa-plus" id="ic5" style="visibility:visible"></i>
																<i class="fa fa-minus" id="ic6" style="visibility:hidden"></i>
																</a>
													<div class="col-md-6" name="3">
													...
													<div class="form-group has-error" id="foo6" style="display:none">
															<label class="control-label col-md-3"><b>Ecart mineur 4 :</b></label><a href="#5" onclick="toggle_visibility('foo7','foo8'),toggle_visibility2('ic7','ic8'),cleartext('text4');">
																<i class="fa fa-plus" id="ic7" style="visibility:visible"></i>
																<i class="fa fa-minus" id="ic8" style="visibility:hidden"></i>
																</a>
													<div class="col-md-6" name="4">
													...
													<div class="form-group has-error" id="foo8" style="display:none">
															<label class="control-label col-md-3"><b>Ecart mineur 5 :</b></label><a href="#6" onclick="toggle_visibility('foo9','foo10'),toggle_visibility2('ic9','ic10'),cleartext('text5');">
																<i class="fa fa-plus" id="ic9" style="visibility:visible"></i>
																<i class="fa fa-minus" id="ic10" style="visibility:hidden"></i>
																</a>
													<div class="col-md-6" name="5">
													...
													<div class="form-group has-error" id="foo10" style="display:none">
															<label class="control-label col-md-3"><b>Ecart mineur 6 :</b></label><a href="#7" onclick="toggle_visibility('foo12','foo11'),toggle_visibility2('ic11','ic12'),cleartext('text6');">
																<i class="fa fa-plus" id="ic11" style="visibility:visible"></i>
																<i class="fa fa-minus" id="ic12" style="visibility:hidden"></i>
																</a>
																
													<div class="col-md-6" name="6">
													...
													<div class="form-group has-error" id="foo12" style="display:none">
															<label class="control-label col-md-3"><b>Ecart mineur 7 :</b></label><a href="#8" onclick="toggle_visibility('foo13','foo14'),toggle_visibility2('ic13','ic14'),cleartext('text7');">
																<i class="fa fa-plus" id="ic13" style="visibility:visible"></i>
																<i class="fa fa-minus" id="ic14" style="visibility:hidden"></i>
																</a>
																
													<div class="col-md-6" name="7">
													...
													<div class="form-group has-error" id="foo14" style="display:none">
															<label class="control-label col-md-3"><b>Ecart mineur 8 :</b></label><a href="#9" onclick="toggle_visibility('foo15','foo16'),toggle_visibility2('ic15','ic16'),cleartext('text8');">
																<i class="fa fa-plus" id="ic15" style="visibility:visible"></i>
																<i class="fa fa-minus" id="ic16" style="visibility:hidden"></i>
																</a>
																
													<div class="col-md-6" name="8">
													...
													<div class="form-group has-error" id="foo16" style="display:none">
															<label class="control-label col-md-3"><b>Ecart mineur 9 :</b></label><a href="#10" onclick="toggle_visibility('foo17','foo18'),toggle_visibility2('ic17','ic18'),cleartext('text9');">
																<i class="fa fa-plus" id="ic17" style="visibility:visible"></i>
																<i class="fa fa-minus" id="ic18" style="visibility:hidden"></i>
																</a>
																
													<div class="col-md-6" name="9">
													...
													<div class="form-group has-error" id="foo18" style="display:none">
															<label class="control-label col-md-3"><b>Ecart mineur 10 :</b></label>
																
													<div class="col-md-6" name="10">
